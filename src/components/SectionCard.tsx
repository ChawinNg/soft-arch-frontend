...
export default function SectionCard({ section }: SectionProps) {
  return (
    <div className="flex flex-row justify-between items-center bg-gray-200 p-4 font-bold ">
      ...
      <div className="flex w-[20%] justify-center items-center flex-col">
        {section.timeslots &&
          section.timeslots.map((timeslot: string) => <div>{timeslot}</div>)}
      </div>
      <div className="flex w-[20%] justify-center items-center">
        {section.capacity}/{section.max_capacity}
      </div>
      <div className="flex w-[20%] justify-center items-center">
        {section.instructors &&
          section.instructors
